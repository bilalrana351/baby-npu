...
void Logger::printStats(const Stats &stats, std::ostream &os) {
  ...
  os << "============================================\n";
  os << "CPU Mode:            " << (stats.isPipelined ? "Pipelined (5-stage)" : "Single-Cycle") << "\n";
  os << "Clock Frequency:     " << std::setw(10) << std::fixed 
     << std::setprecision(1) << stats.getClockFrequencyMHz() << " MHz\n";
  os << "Clock Period:        " << std::setw(10) << std::fixed
     << std::setprecision(2) << stats.clockPeriodNs << " ns\n";
  os << "--------------------------------------------\n";
  ...
  os << "--------------------------------------------\n";
  os << "Execution Time:      " << std::setw(10) << std::fixed
     << std::setprecision(2) << stats.getExecutionTimeNs() << " ns\n";
  os << "                     " << std::setw(10) << std::fixed
     << std::setprecision(3) << stats.getExecutionTimeUs() << " μs\n";
  os << "Throughput:          " << std::setw(10) << std::fixed
     << std::setprecision(1) << stats.getMIPS() << " MIPS\n";
  os << "--------------------------------------------\n";
...
void Logger::printPipelineStats(const Stats &stats, const PipelineStats &pipeStats, 
                                 std::ostream &os) {
  os << "\n";
  os << "============================================\n";
  os << "    PIPELINED EXECUTION STATISTICS          \n";
  os << "============================================\n";
  os << "Clock Frequency:     " << std::setw(10) << std::fixed 
     << std::setprecision(1) << stats.getClockFrequencyMHz() << " MHz\n";
  os << "Clock Period:        " << std::setw(10) << std::fixed
  ...
  os << "Throughput:          " << std::setw(10) << std::fixed
     << std::setprecision(1) << stats.getMIPS() << " MIPS\n";
  os << "--------------------------------------------\n";
  os << "Pipeline Stalls:     " << std::setw(10) << pipeStats.stallCycles << "\n";
  os << "  Load-Use Stalls:   " << std::setw(10) << pipeStats.loadUseStalls << "\n";
  os << "Pipeline Flushes:    " << std::setw(10) << pipeStats.flushCycles << "\n";
  os << "  Branch Flushes:    " << std::setw(10) << pipeStats.branchFlushes << "\n";
  os << "Forwarding Events:   " << std::setw(10) << pipeStats.forwardCount << "\n";
  os << "Data Hazards:        " << std::setw(10) << pipeStats.dataHazards << "\n";
  os << "Control Hazards:     " << std::setw(10) << pipeStats.controlHazards << "\n";
  os << "--------------------------------------------\n";
  os << "NPU Instructions:    " << std::setw(10) << stats.npuInstructions
     << "\n";
  os << "Scalar Instructions: " << std::setw(10) << stats.scalarInstructions
  ...
  os << "Branches Not Taken:  " << std::setw(10) << stats.branchesNotTaken
     << "\n";
  os << "============================================\n";
  os << "Ideal CPI (no hazards): 1.000\n";
  os << "Overhead from hazards:  " << std::fixed << std::setprecision(3)
     << (stats.getCPI() - 1.0) << "\n";
  os << "============================================\n";
}
