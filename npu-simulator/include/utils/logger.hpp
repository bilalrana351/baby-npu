...
// Forward declaration for PipelineStats
...
public:
    ...
    static void printPipelineStats(const Stats& stats, const PipelineStats& pipeStats,
...
// Include PipelineStats definition if needed
#include "../cpu/pipelined.hpp"
